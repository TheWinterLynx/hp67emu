...
## Implementation
Builds an `eframe::NativeOptions` with a resizable viewport and 4× MSAA, then calls `eframe::run_native`. The test checks that no maximum window size is imposed.
