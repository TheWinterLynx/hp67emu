...
- The section headed **“Woodstock – HP-67”** contains HP-67-specific logic-analyser captures of PHI1, PHI2, Sync, Is and Data.
...
- Page 70 directly shows PHI1/PHI2 as alternating low-going pulses from a normally high level; the observed pulses do not overlap. Its expanded SYNC captures also show both SYNC rising and falling transitions aligned with the rising edge of PHI2. This fixes clock pin polarity/order and the SYNC edge anchor, but not pulse widths/dead time, quantified propagation delay, or the exact IS/DATA launch/sample edges.
