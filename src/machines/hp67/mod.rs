...
pub use timing::{
    ...
    DISPLAY_DATA_FIRST_BIT, DISPLAY_DATA_LAST_BIT, DISPLAY_STR_BIT,
    ...
    HP67_OBSERVED_POWER_ON_SYNC_DELAY_US, HP67_OBSERVED_WORD_TIME_US, ROM_ADDRESS_BITS,
    ROM_ADDRESS_FIRST_BIT, ROM_ADDRESS_LAST_BIT, ROM_WORD_BITS, ROM_WORD_FIRST_BIT,
    ROM_WORD_LAST_BIT,
};
