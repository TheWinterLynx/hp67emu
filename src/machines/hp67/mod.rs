...
pub use timing::{
    ...
    HP67_EDGE_CONTRACTS_V1, HP67_EDGE_CONTRACT_VERSION, HP67_OBSERVED_POWER_ON_SYNC_DELAY_US,
    HP67_OBSERVED_WORD_TIME_US, HP67_SYNC_TRANSITION_EDGE, ROM_ADDRESS_BITS, ROM_ADDRESS_FIRST_BIT, ROM_ADDRESS_LAST_BIT, ROM_WORD_BITS,
