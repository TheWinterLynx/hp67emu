...
pub use timing::{
    ...
    sync_decision_window, Hp67ClockEdge, Hp67ClockPhase, Hp67WordTiming, IsaWindow, BITS_PER_DIGIT,
    BITS_PER_WORD, DATA_STREAM_BITS, DATA_STREAM_FIRST_WORD_BIT, DIGITS_PER_WORD,
    DISPLAY_DATA_BITS, DISPLAY_DATA_FIRST_BIT, DISPLAY_DATA_LAST_BIT, DISPLAY_STR_BIT,
    HP67_OBSERVED_DISPLAY_DP_ON_US, HP67_OBSERVED_DISPLAY_DP_TO_STR_GAP_US,
    HP67_OBSERVED_DISPLAY_REFRESH_US, HP67_OBSERVED_DISPLAY_SEGMENT_ON_US,
    HP67_OBSERVED_DISPLAY_STR_PULSE_US, HP67_OBSERVED_POWER_ON_SIGNAL_STABILIZE_US,
    HP67_OBSERVED_POWER_ON_SYNC_DELAY_US, HP67_OBSERVED_WORD_TIME_US, HP67_SYNC_TRANSITION_EDGE,
    ROM_ADDRESS_BITS, ROM_ADDRESS_FIRST_BIT, ROM_ADDRESS_LAST_BIT, ROM_WORD_BITS,
    ROM_WORD_FIRST_BIT, ROM_WORD_LAST_BIT,
};
