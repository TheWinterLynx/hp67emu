...
pub use timing::{
    ...
    BITS_PER_WORD, DATA_STREAM_BITS, DATA_STREAM_FIRST_WORD_BIT, DIGITS_PER_WORD, DISPLAY_DATA_BITS,
    ...
    HP67_OBSERVED_WORD_TIME_US, HP67_SYNC_TRANSITION_EDGE, ROM_ADDRESS_BITS, ROM_ADDRESS_FIRST_BIT, ROM_ADDRESS_LAST_BIT,
