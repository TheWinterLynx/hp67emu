...
pub enum Mark {
    ...
    Xbar,
    Exchange(&'static str, &'static str, bool),
    Compare(char, bool),
    TextPower(&'static str, &'static str),
    RadicalPower,
    Inverse(&'static str),
    UnaryStack,
}
...
pub const CELLS: &[Cell] = &[
    ...
    c(2, 58., 46., Xbar),
    c(2, 112., 46., Pair("GSB", "f")),
    c(2, 166., 48., Pair("FIX", "SCI")),
    c(2, 220., 46., Text("RND", false)),
    c(2, 274., 46., Pair("LBL", "f")),
    c(3, 166., 48., Pair("DSZ", "(i)")),
    c(3, 220., 48., Pair("ISZ", "(i)")),
    c(4, 56., 58., Text("W/DATA", false)),
    c(4, 119., 58., Text("MERGE", true)),
    c(4, 166., 34., Exchange("P", "S", false)),
    c(4, 220., 48., Text("CL REG", false)),
    c(4, 274., 48., Text("CL PRGM", false)),
    c(5, 56., 58., Compare('=', false)),
    c(5, 119., 62., TextPower("LN", "e")),
    c(5, 194., 66., TextPower("LOG", "10")),
    ...
    c(7, 119., 62., Exchange("R", "P", true)),
    c(7, 194., 66., Exchange("D", "R", true)),
    c(7, 270., 66., Exchange("H", "H.MS", true)),
    c(8, 56., 58., Compare('>', false)),
    c(8, 119., 62., Pair("%", "%CH")),
    c(8, 194., 66., Pair("INT", "FRAC")),
