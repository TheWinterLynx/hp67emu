...
//! provides explicit time, electrical net resolution, device contracts,
//! deterministic scheduling and trace capture that calculator-specific machines
//! can build on.
...
pub use scheduler::{ElectricalScheduler, SchedulerError};
